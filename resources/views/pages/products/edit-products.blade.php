                    ...
                    <div class="col-md-4">
                                    ...
                                    <select name="supplier" id="supplier" class="form-control" value="">
                                        ...
                                        @if ($Suppliers->isNotEmpty())
                                            @foreach ($Suppliers as $Supplier)
                                                <option {{ $Supplier->id == $Product->supplier ? 'selected' : '' }}
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="band" id="band" class="form-control" value="">
                                        <option value="">No Bands</option>
...
@push('js')
    <script>
        ...
        $('#Product_form').submit(function(event) {
            ...
            var Product_form = $(this).serializeArray();
            var id = $('#id').val();
            $.ajax({
                ...
                success: function(response) {
                    if (response['status'] == true) {
                        ...
                        Swal.fire({
                            title: "Success",
                            text: "Product Modify Successfully!",
                            icon: "success"
                        }).then(function() {
